...
@dlt.source
def engineer_jobsearch_source(api_secret_key: str = dlt.secrets.value):
    # print(f"api_secret_key={api_secret_key}")
    return engineer_jobsearch_resource(api_secret_key)


@dlt.resource(write_disposition="append")
def engineer_jobsearch_resource(
...
if __name__ == "__main__":
    ...
    pipeline = dlt.pipeline(
        ...
        dataset_name='engineer_jobsearch_data',
    )

    data = list(engineer_jobsearch_resource())
